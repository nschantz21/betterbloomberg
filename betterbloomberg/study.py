...
class Study(BlpDataRequest):
    ...
    def __init__(self, security, study, start, end, data_range="historical", interval=15, **kwargs):
    ...
    def generate_request(self):
        ...
        # study attributes
        self.request.getElement("studyAttributes").setChoice(self.study + "StudyAttributes")
        study_attributes = self.request.getElement("studyAttributes").getElement(self.study + "StudyAttributes")
